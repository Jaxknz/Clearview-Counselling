...
function Home() {
  return (
    <div className="min-h-screen">
      <section className="bg-nature-gradient text-white py-24 px-8 md:py-16 md:px-4 text-center relative overflow-hidden before:content-[''] before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_10%_20%,rgba(255,255,255,0.1)_0%,transparent_50%),radial-gradient(circle_at_90%_80%,rgba(255,255,255,0.08)_0%,transparent_50%)] before:pointer-events-none">
        <div className="max-w-3xl mx-auto relative z-10">
          <h1 className="text-5xl md:text-4xl font-bold mb-4 drop-shadow-[2px_2px_4px_rgba(0,0,0,0.2)]">Welcome to Clearview Counselling</h1>
          <p className="text-2xl md:text-xl mb-6 opacity-95">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link to="/signup" className="px-10 py-4 rounded-lg no-underline font-semibold text-lg transition-all duration-300 inline-block bg-white text-primary shadow-[0_4px_12px_rgba(255,255,255,0.3)] hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(255,255,255,0.4)] hover:bg-white/95">
              Get Started
            </Link>
            <Link to="/about" className="px-10 py-4 rounded-lg no-underline font-semibold text-lg transition-all duration-300 inline-block bg-transparent text-white border-2 border-white/90 backdrop-blur-[10px] hover:bg-white/20 hover:border-white hover:-translate-y-0.5">
              Learn More
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 px-8 md:py-12 md:px-4 bg-gradient-to-b from-white via-sky/10 to-nature-green/10 relative before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-48 before:bg-gradient-to-b before:from-transparent before:to-[rgba(175,214,241,0.2)] before:pointer-events-none">
        <div className="max-w-6xl mx-auto px-8 md:px-0 relative z-10">
          <h2 className="text-center text-4xl md:text-3xl text-text-dark mb-12 md:mb-8 font-bold">Our Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-6">
            <div className="bg-gradient-to-br from-white via-sky/10 to-nature-green/5 p-10 md:p-6 rounded-xl text-center transition-all duration-300 border-2 border-primary/20 hover:-translate-y-1 hover:shadow-custom-lg hover:border-primary hover:bg-gradient-to-br hover:from-sky/15 hover:via-white hover:to-nature-green/10">
              ...
              <h3 className="text-2xl md:text-xl text-text-dark mb-4">Free Discovery Call</h3>
      ...
      <section className="py-20 px-8 md:py-12 md:px-4 bg-gradient-to-b from-bg-light via-white to-primary/5">
        <div className="max-w-6xl mx-auto px-8 md:px-0">
          <h2 className="text-center text-4xl md:text-3xl text-text-dark mb-12 md:mb-8 font-bold">Why Choose Clearview Counselling?</h2>
      ...
      <section className="py-20 px-8 md:py-12 md:px-4 bg-earth-gradient text-white text-center relative overflow-hidden before:content-[''] before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_20%_30%,rgba(255,255,255,0.1)_0%,transparent_50%),radial-gradient(circle_at_80%_70%,rgba(255,255,255,0.08)_0%,transparent_50%)] before:pointer-events-none">
        <div className="max-w-6xl mx-auto px-8 md:px-0 relative z-10">
          <h2 className="text-4xl md:text-3xl mb-4">Ready to Begin Your Journey?</h2>
          <p className="text-xl md:text-lg mb-8 opacity-95">Take the first step towards a clearer, brighter future</p>
          <Link to="/signup" className="px-12 py-5 md:px-10 md:py-4 rounded-lg no-underline font-semibold text-xl md:text-lg transition-all duration-300 inline-block bg-white text-primary shadow-[0_4px_12px_rgba(255,255,255,0.3)] hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(255,255,255,0.4)] hover:bg-white/95">
            Sign Up Today
          </Link>
        </div>
      </section>
