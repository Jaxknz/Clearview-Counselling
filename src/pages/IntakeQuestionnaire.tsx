...
function IntakeQuestionnaire() {
    ...
    return (
      <div className="min-h-[calc(100vh-80px)] p-4 sm:p-6 lg:p-8 bg-bg-light">
        <div className="text-center mb-6 sm:mb-8 px-4">
          <h1 className="text-3xl sm:text-4xl lg:text-4xl font-bold mb-2 bg-gradient-to-br from-primary to-secondary bg-clip-text text-transparent">Intake Questionnaire</h1>
          <p className="text-base sm:text-lg text-text-light">Your questionnaire has already been completed</p>
        </div>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 bg-white p-6 sm:p-8 lg:p-12 rounded-2xl shadow-custom-lg">
          <div className="text-center py-8 sm:py-12 px-4 sm:px-8 bg-bg-light rounded-xl my-6 sm:my-8">
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] p-4 sm:p-6 lg:p-8 bg-bg-light">
      <div className="text-center mb-6 sm:mb-8 px-4">
        <h1 className="text-3xl sm:text-4xl lg:text-4xl font-bold mb-2 bg-gradient-to-br from-primary to-secondary bg-clip-text text-transparent">Intake Questionnaire</h1>
        <p className="text-base sm:text-lg text-text-light mb-4 sm:mb-6">Help us understand your needs better</p>
        <div className="w-full max-w-[600px] h-2 bg-border rounded-full mx-auto mb-3 sm:mb-4 overflow-hidden">
          <div 
      ...
      <form onSubmit={handleSubmit} className="max-w-3xl mx-auto px-4 sm:px-6 bg-white p-6 sm:p-8 lg:p-10 rounded-2xl shadow-custom-lg">
        {currentStep === 1 && (
          <div className="animate-fadeIn">
            <h2 className="text-text-dark text-2xl sm:text-3xl lg:text-3xl mb-4 sm:mb-6 pb-2 sm:pb-3 border-b-2 border-border">Background Information</h2>
        ...
        {currentStep === 2 && (
          <div className="animate-fadeIn">
            <h2 className="text-text-dark text-2xl sm:text-3xl lg:text-3xl mb-4 sm:mb-6 pb-2 sm:pb-3 border-b-2 border-border">Health & Goals</h2>
        ...
        {currentStep === 3 && (
          <div className="animate-fadeIn">
            <h2 className="text-text-dark text-2xl sm:text-3xl lg:text-3xl mb-4 sm:mb-6 pb-2 sm:pb-3 border-b-2 border-border">Emergency & Additional Information</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
              ...
              <div>
                <label htmlFor="emergencyPhone" className="block font-semibold text-text-dark mb-2 text-xs sm:text-sm">
            ...
            <div className="mb-4 sm:mb-6">
              <label htmlFor="additionalInfo" className="block font-semibold text-text-dark mb-2 text-xs sm:text-sm">
              ...
              <textarea
                ...
                className="w-full py-2.5 sm:py-3 px-3 border-2 border-border rounded-lg text-sm sm:text-base transition-all duration-300 font-inherit resize-y focus:border-primary focus:shadow-[0_0_0_3px_rgba(74,144,226,0.1)] focus:outline-none"
              />
            </div>
          </div>
        )}

        <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 sm:gap-4 mt-6 sm:mt-8 pt-4 sm:pt-6 border-t-2 border-border">
          {currentStep > 1 && (
            <button type="button" onClick={handleBack} className="w-full sm:w-auto py-2.5 sm:py-3 px-6 sm:px-8 bg-bg-light text-text-dark border-2 border-border rounded-lg font-semibold text-sm sm:text-base cursor-pointer transition-all duration-300 hover:bg-border">
              Back
            </button>
          )}
          {currentStep < totalSteps ? (
            <button type="button" onClick={handleNext} className="w-full sm:w-auto sm:ml-auto py-2.5 sm:py-3 px-6 sm:px-8 bg-nature-gradient text-white border-none rounded-lg font-semibold text-sm sm:text-base cursor-pointer transition-all duration-300 hover:-translate-y-0.5 hover:shadow-custom-lg">
              Next
            </button>
          ) : (
            <button type="submit" className="w-full sm:w-auto sm:ml-auto py-2.5 sm:py-3 px-6 sm:px-8 bg-nature-gradient text-white border-none rounded-lg font-semibold text-sm sm:text-base cursor-pointer transition-all duration-300 hover:-translate-y-0.5 hover:shadow-custom-lg">
              Continue to Payment
            </button>
          )}
        </div>
